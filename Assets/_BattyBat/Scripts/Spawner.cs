...
using UnityEngine;
using UnityEngine.Pool; // Bắt buộc dòng này

public class Spawner : MonoBehaviour
{
    [SerializeField] Rosin _rosinPrefab;
    [SerializeField] Transform _spawnPoint;

    public static float SpawnerTime = 1.5f;

    [MinMaxSlider(-5f, 5f)] 
    [SerializeField] Vector2 _spawnHeightRange = new Vector2(-2f, 2f);
    private ObjectPool<Rosin> _pool;

    private void Awake()
    {
        // Khởi tạo Pool (Cực kỳ quan trọng)
